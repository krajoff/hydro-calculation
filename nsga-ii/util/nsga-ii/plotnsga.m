...
if(numObj == 2)
    ...
    % Èíäåêñû òî÷åê, êîòîðûå óäîâëåòâîðÿþò óñëîâèþ
    ...
    % Ñòðîèì òî÷êè, êîòîðûå íå óäîâëåòâîðÿþò óñëîâèþ (ñèíèå)
    plot(x_data(~red_indices), y_data(~red_indices), 'ob');
    hold on;
    
    % Ñòðîèì òî÷êè, êîòîðûå óäîâëåòâîðÿþò óñëîâèþ (êðàñíûå)
    plot(x_data(red_indices), y_data(red_indices), 'or', ...
    'MarkerEdgeColor', 'r'); % êðàñíûå òî÷êè
    hold off;
