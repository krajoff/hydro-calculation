...
[id, genType] = readData('input_435_190_10.m', sf, cf);
%[id, genType] = readData('input_670_170_44.dat', sf, cf);
%[id, genType] = readData('input_820_175_80.dat', sf, cf);
%[id, genType] = readData('input_1285_275_42.dat', sf, cf);
